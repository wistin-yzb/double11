...
$auto = $_GET['auto']?$_GET['auto']:5; //5s自动更新一次数据
...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>                 
            <tr class="tr1">            
                ...
                <td><a href="/rd.php">查看</a>
		&nbsp;<a href="/rd.php?auto=1">自动</a></td>
            </tr>    
        </tbody>
    </table>
</div>
   <script>
   <?php if($auto == 1):?>
	setTimeout("document.location.href = '<?php echo $domain;?>/rd.php?auto=1'",10 * 1000);
	<?php elseif($auto == 5):?>
	setTimeout("document.location.href = ''",5 * 1000);
	<?php endif;?>
  </script>
</body>
</html>