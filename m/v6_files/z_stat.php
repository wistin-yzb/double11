(function() {
    ...
    var q = function() {
        for (var a = document.getElementsByTagName("script"), b = 0, c = a.length; b < c; b++) {
            var d, e = a[b];
            if (e.src && (d = /^(https?:)\/\/[\w\.\-]+\.cnzz\.com\//i.exec(e.src)))
                return d[1]
        }
        ...
        Z: function() {
            try {
                ...
                if (1E8 < this.c) {
                    ...
                    b.push(this.D);
                    0 < b.length ? (a += f(b.join("|")),
                    a += "; expires=" + c.toUTCString(),
                    a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString()
                } else
                    "none" !== this.a.l ? b.push("cnzz_eid=" + f(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.D + "-" + this.M(this.o()),
                    b.push("cnzz_eid=" + f(d))),
                    b.push("ntime=" + this.D),
                    0 < b.length ? (a += f(b.join("&")),
                    a += "; expires=" + c.toUTCString(),
        ...
        pa: function(a, b) {
            try {
                ...
                if (c) {
                    ...
                    "0" === this.A && h.write(r("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
            } catch (n) {
                g(n, "cSI failed")
            }
        },
